...
* **Connect over WiFi:** Connect your phone/laptop to your device's WiFi
  ...
  Click past your browser warning you about the connection not being secure; VNCSSdetector doesn't have HTTPS yet.
...
As of VNCSSdetector version 0.3.3, you can start a new recording by double-tapping the power button. Any current recording will be stopped and a new recording will be started, resetting the red line as well. This feature is disabled by default since VNCSSdetector version 0.4.0 and needs to be enabled through [configuration](./configuration.md).
