# Installing VNCSSdetector

So, you've got one of the [supported devices](./supported-devices.md), and are ready to start catching IMSI catchers. You have two options for installing VNCSSdetector:
