...
### Do I need an active SIM card to use VNCSSdetector?

**It Depends**. Operation of VNCSSdetector does require the insertion of a SIM card into the device, but that sim card does not have to be actively registered with a service plan. If you want to use the device as a hotspot in addition to a research device, or get [notifications](./configuration.md), an active plan would of course be necessary.
...
### Help, VNCSSdetector's line is red/orange/yellow/dotted/dashed! What should I do?
...
If you've received a VNCSSdetector warning and would like to help us with our research, please send your VNCSSdetector data captures (Zip file downloaded from the web interface) to us at our [Signal](https://signal.org/) username [**ElectronicFrontierFoundation.90**](https://signal.me/#eu/HZbPPED5LyMkbTxJsG2PtWc2TXxPUR1OxBMcJGLOPeeCDGPuaTpOi5cfGRY6RrGf) with the following information: capture date, capture location, device, device model, and VNCSSdetector version. If you're unfamiliar with Signal, feel free to check out our [Security Self Defense guide on it](https://ssd.eff.org/module/how-to-use-signal).
...
### How do I re-enable USB tethering after installing VNCSSdetector?
