...
VNCSSdetector is confirmed to work on these devices.
...
| [FY MSM8916](./msm8916.md) | Asia, Europe |
| [Moxee hotspot](./moxee.md) | Americas |

## Adding new devices
VNCSSdetector was built and tested primarily on the Orbic RC400L mobile hotspot, but the community has been working hard at adding support for other devices. Theoretically, if a device runs a Qualcomm modem and exposes a `/dev/diag` interface, VNCSSdetector may work on it.

If you have a device in mind which you'd like VNCSSdetector to support, please [open a discussion on our Github](https://github.com/EFForg/vncssdetector/discussions)!
