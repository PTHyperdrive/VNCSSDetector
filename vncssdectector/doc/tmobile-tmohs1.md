...
## LED modes
| VNCSSdetector state  | LED indicator                  |
| ---------------- | ------------------------------ |
...
## Obtaining a shell
Even when vncssdetector is running, for security reasons the TMOHS1 will not have telnet or adb enabled during normal operation.
