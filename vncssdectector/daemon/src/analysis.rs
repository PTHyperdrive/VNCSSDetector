...
use log::{error, info};
use vncssdetector::analysis::analyzer::{AnalyzerConfig, EventType, Harness};
use vncssdetector::diag::{DataType, MessagesContainer};
use vncssdetector::qmdl::QmdlReader;
use serde::Serialize;
use tokio::fs::File;
...
// state VNCSSdetector has to keep track of in memory. The analysis file's format is
