...
use log::{info, warn};
use vncssdetector::util::RuntimeMetadata;
...
pub struct ManifestEntry {
    ...
    pub vncssdetector_version: Option<String>,
...
impl ManifestEntry {
    fn new() -> Self {
        ...
        ManifestEntry {
            ...
            qmdl_size_bytes: 0,
            vncssdetector_version: Some(metadata.vncssdetector_version),
